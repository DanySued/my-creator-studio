...
import { Users, Send, Bot, Settings, LogOut, Sparkles } from "lucide-react";
  ...
  return (
    <aside className="flex flex-col w-56 shrink-0 border-r border-border bg-sidebar h-full">
      <div className="flex items-center gap-2.5 h-14 px-4 border-b border-border">
        ...
        <span className="text-sm font-semibold text-foreground tracking-tight">Instagram Bot</span>
      </div>
